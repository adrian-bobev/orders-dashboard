            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                ...
                <ul className="text-neutral-600 text-sm mt-1 ml-4 list-disc space-y-1">
                  ...
                  <li>Стъпка 2: Оригирано съдържание</li>
                  <li>Стъпка 3: Scene Prompts</li>
                  <li>Стъпка 4: Референтни изображения на герои</li>
                  <li>Стъпка 5: Генерирани изображения на сцени</li>
