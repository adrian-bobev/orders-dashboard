      ...
      {reference ? (
        <div className="relative w-full h-20 rounded overflow-hidden mb-2 bg-neutral-100">
          ...
          {entity.is_main_character && (
            <div className={`absolute top-1 left-1 ${colors.bg} text-white text-xs px-1.5 py-0.5 rounded font-bold`}>
              Главен
            </div>
          )}
        </div>
      ) : (
        <div className="relative w-full h-20 rounded bg-neutral-100 mb-2 flex items-center justify-center">
