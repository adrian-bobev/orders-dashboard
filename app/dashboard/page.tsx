  ...
  if (!user) {
    return (
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-3xl p-8 shadow-warm border border-purple-100">
        ...
        <div className="flex items-start justify-between gap-6">
          <div className="flex-1">
            ...
            <p className="text-lg text-neutral-600 leading-relaxed">
              Здравейте, <span className="font-bold text-purple-900">{user.name || user.email}</span>!
              {" "}Влезли сте като{" "}
