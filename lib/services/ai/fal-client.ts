...
export interface FalImageGenerationParams {
  ...
  size?: 'auto' | '1024x1024' | '1536x1024' | '1024x1536' | 'auto_4K' | 'auto_2K' | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | { width: number; height: number }
  numImages?: number
